...
ops.fbinary             = '/rigel/zi/users/ccr2137/neural/sort20200404125257/exp.dat'; % will be created for 'openEphys'		
ops.fproc               = '/rigel/zi/users/ccr2137/neural/sort20200404125257/temp_wh.dat'; % residual from RAM of preprocessed data		
ops.root                = '/rigel/zi/users/ccr2137/neural/sort20200404125257'; % 'openEphys' only: where raw files are		
...
ops.chanMap             = '/rigel/zi/users/ccr2137/neural/sort20200404125257/chmap.mat'; % make this file using createChannelMapFile.m		
