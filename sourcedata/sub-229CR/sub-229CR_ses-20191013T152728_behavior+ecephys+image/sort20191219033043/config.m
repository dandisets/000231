...
ops.fbinary             = '/rigel/zi/users/ccr2137/neural/sort20191219033043/exp.dat'; % will be created for 'openEphys'		
ops.fproc               = '/rigel/zi/users/ccr2137/neural/sort20191219033043/temp_wh.dat'; % residual from RAM of preprocessed data		
ops.root                = '/rigel/zi/users/ccr2137/neural/sort20191219033043'; % 'openEphys' only: where raw files are		
...
ops.nNeigh              = 64; % visualization only (Phy): number of neighboring templates to retain projections of (16)		
...
ops.chanMap             = '/rigel/zi/users/ccr2137/neural/sort20191219033043/chmap.mat'; % make this file using createChannelMapFile.m		
...
ops.ForceMaxRAMforDat   = 15e9; % maximum RAM the algorithm will try to use; on Windows it will autodetect.
